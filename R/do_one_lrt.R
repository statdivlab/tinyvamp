do_one_lrt <- function(
  ...
  boot_full <- estimate_parameters(
    ...
    gammas = full_model$gammas,
    gammas_fixed_indices = full_model$gammas_fixed_indices,
    P = full_model$P,
    ...
    gamma_tilde_fixed_indices = full_model$gamma_tilde_fixed_indices,
  ...
  if (verbose) {
    message(paste0("full model weights sum to "), sum(boot_weights))
  }
  ...
  boot_null <- estimate_parameters(
    ...
    gammas = null_model$gammas,
    gammas_fixed_indices = null_model$gammas_fixed_indices,
    P = null_model$P,
    ...
    gamma_tilde_fixed_indices = null_model$gamma_tilde_fixed_indices,
  ...
  if (verbose) {
    message(paste0("null model weights sum to "), sum(boot_weights))
  }
