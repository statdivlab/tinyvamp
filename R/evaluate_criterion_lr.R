...
#'   related auxiliary structures used by [meaninate()].
...
#' @param wts Optional numeric weights passed to [poisson_criterion()].
#' @param gmm_inv_wts Optional inverse weighting matrix or vector for the GMM
#'   criterion. If `NULL`, it is estimated internally using
#'   [get_gmm_inv_weights()].
